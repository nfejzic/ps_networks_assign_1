...
def parse_args():
    ...
    parser.add_argument("csv_file", help="CSV file with the TCP sequence numbers and timestamps")
    parser.add_argument("file_suffix", help="output file suffix")
...
if __name__ == "__main__":
    ...
    filename = f"tcp_time_seq_{iteration}_{args.file_suffix}.png"
